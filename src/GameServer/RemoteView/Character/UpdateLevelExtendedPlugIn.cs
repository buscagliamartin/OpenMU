...
/// <summary>
/// The extended implementation of the <see cref="IUpdateLevelPlugIn"/> which forwards level updates to the game client.
/// </summary>
[PlugIn(nameof(UpdateLevelExtendedPlugIn), "The extended implementation of the IUpdateLevelPlugIn which forwards level updates to the game client.")]
