...
/// <summary>
/// The extended implementation of the <see cref="IUpdateCharacterBaseStatsPlugIn"/> which forwards base stats to the game client.
/// </summary>
[PlugIn(nameof(UpdateCharacterBaseStatsExtendedPlugIn), "The extended implementation of the IUpdateCharacterBaseStatsPlugIn which forwards base stats to the game client.")]
