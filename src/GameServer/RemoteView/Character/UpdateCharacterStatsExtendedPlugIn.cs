...
/// <summary>
/// The extended implementation of the <see cref="IUpdateCharacterStatsPlugIn"/> which forwards extended character stats to the game client.
/// </summary>
[PlugIn(nameof(UpdateCharacterStatsExtendedPlugIn), "The extended implementation of the IUpdateCharacterStatsPlugIn which forwards extended character stats to the game client.")]
...
public class UpdateCharacterStatsExtendedPlugIn : IUpdateCharacterStatsPlugIn
{
    ...
    public async ValueTask UpdateCharacterStatsAsync()
    {
        ...
        if (connection is null || this._player.Account is null || this._player.Attributes is null)
        {
            return;
        }
