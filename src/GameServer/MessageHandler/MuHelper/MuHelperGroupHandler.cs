...
/// <summary>
/// Packet handler for custom BarnaMu packets (0xBF identifier).
/// </summary>
[PlugIn("Custom 0xBF Packet Handler", "Generic dispatcher for custom BarnaMu 0xBF sub-packets.")]
...
internal class MuHelperGroupHandler : GroupPacketHandlerPlugIn
{
    ...
    public MuHelperGroupHandler(IClientVersionProvider clientVersionProvider, PlugInManager manager, ILoggerFactory loggerFactory)
